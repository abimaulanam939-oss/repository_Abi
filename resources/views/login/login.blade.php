...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
        ...
        .subtitle { color: gray; margin-bottom: 25px; font-size: 14px; }
        .input-group { margin-bottom: 18px; text-align: left; }
        .password-container { position: relative; }
        label { font-size: 12px; color: #555; margin-bottom: 5px; display: block; }
        input { width: 100%; padding: 12px; padding-right: 40px; border-radius: 10px; border: 1px solid #ddd; font-size: 14px; }
        input:focus { border-color: #2c5364; outline: none; }
        #togglePassword { position: absolute; right: 15px; top: 50%; transform: translateY(-50%); cursor: pointer; color: #777; }
        ...
        .error { background: #ffe5e5; color: red; padding: 10px; border-radius: 8px; margin-bottom: 15px; font-size: 14px; }
        .success { background: #e5ffe5; color: green; padding: 10px; border-radius: 8px; margin-bottom: 15px; font-size: 14px; }
    </style>
</head>
<body>
